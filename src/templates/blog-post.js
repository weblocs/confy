    ...
    return (
        ...
        <div>
            ...
            <div style={{background: 'rgba(0,0,0,.4)', width: '100%', height: '100%', borderRadius: 10}}>
                <h1 style={{position: 'absolute', bottom: 40, left: 40, color: '#fff', marginBottom: 0}}>{postData.data.Name}</h1>
            </div>
            </div>
            <p style={{maxWidth: 600, marginLeft: 40, marginTop: 40,
    fontWeight: 300,
    textAlign: 'justify'}}>{postData.data.description}</p>
    <div style={{marginLeft: 40}}>
      <iframe title={postData.data.Name} style={{border: 'none'}} width="420" height="315"
